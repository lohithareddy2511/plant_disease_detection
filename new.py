...
# Prediction Page
    ...
    if st.button("Predict") and test_image:
       ...
       # st.write(f"Suggested nearby Agro Farms  {predicted_disease}: {treatment_suggestion}")
        ...
        class_loc = 'Vasavi College of Engineering, Hyderabad'
        # Get nearby shops
        treatment_suggestion5 = get_nearby_shops(predicted_disease, class_loc)
        st.write(f"Nearby Shops for {predicted_disease}: {treatment_suggestion5}")
        # Nearby Shops Page
